...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
        ...
        /* 2-  a test that loops through each feed
    ...
    describe('The menu',function(){
       ...
       /* 3- a test that ensures the menu element is
         * hidden by default. */
        ...
        it('the menu element is hidden', function (){
         ...
         /* 4- a test that ensures the menu changes
          * visibility when the menu icon is clicked. This test
          * should have two expectations: does the menu display when
          * clicked and does it hide when clicked again.
          */
         it('menu changes are visible on click', function(){
    ...
    describe('Initial Entries', function () {
        ...
        /* 5- a test that ensures when the loadFeed
    ...
    describe('New Feed Selection', function() {
		...
		afterEach(function() {
          ...
          /*  6- test that ensures when a new feed is loaded
